...
class Header extends Component{
   ...
   jwtDecode = () => {
    ...
    componentDidMount(){
      ...
      axios.get('api/auth/getUserProfile/'+this.jwtDecode())
      .then((res) => {
    ...
    render() {
      ...
      <Dialog onClose={() => {
      ...
      }} aria-labelledby="customized-dialog-title" open={this.state.signInModal}>
           <div style={{
        ...
        }} aria-labelledby="customized-dialog-title" open={this.state.signModal}>
                <Sign />
                <br/>
             ...
             <Nav className="ml-auto" navbar>
               <NavLink id="content-link" to="/searchMarketPlace">
                 ...
                 <b className="nav-links" onClick={() => {
                   ...
                   <img src={""+this.state.profile.profilePic} style={{height:"50px" ,width:"50px", borderRadius:"26px"}} alt="#####"/>
                 </b>
                 </span>
             </NavItem>
